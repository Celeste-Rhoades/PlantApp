...
const PlantPurchaseOptions = props => {
  ...
  return (
    <>
      ...
      <div className="flex">
        <div className="flex items-center px-3 py-2 text-xl border-2 rounded-full text-slate-500 border-slate-300">
          <button
            onClick={() => {
              if (quantity > 1) {
        ...
        <button
          className="flex items-center justify-center flex-1 ml-2 text-xl text-white rounded-full bg-emerald-700 hover:bg-emerald-800"
          onClick={async () => {
            setIsLoading(true);
